...
```sh
## Download
wget -c https://github.com/pearlfortune/pearl-miner/releases/download/v2.2.4/pearlfortune-v2.2.4.tar.gz \
&& tar vxzf pearlfortune-v2.2.4.tar.gz \
&& cd pearlfortune
    ...
    "items": [
        {
            ...
            "miner_config": {
                ...
                "miner": "pearlfortune",
                "template": "%WAL%",
                "install_url": "https://github.com/pearlfortune/pearl-miner/releases/download/v2.2.4/pearlfortune-v2.2.4.tar.gz",
                "user_config": ""
            },
            "pool_geo": [
...
docker run -d \
    ...
    --gpus all \
    pearlfortune/pearl-miner:v2.2.4 \
    --proxy global.pearlfortune.org:443 \
    --address {prl-address} \
    --worker "$(hostname)" \
    -gpu
...
1. Download and unzip `miner-windows-v2.2.4.zip`.
